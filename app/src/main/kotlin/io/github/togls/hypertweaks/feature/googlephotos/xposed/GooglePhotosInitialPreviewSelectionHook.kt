...
internal class GooglePhotosInitialPreviewSelectionHook(
    ...
    private fun installBoundsUpdateInterceptor() {
        ...
        module.hook(binding.boundsUpdateMethod)
    ...
    private fun installSelectionInterceptor() {
        ...
        module.hook(binding.selectionMethod)
            .setExceptionMode(XposedInterface.ExceptionMode.PROTECTIVE)
            .intercept(::interceptSelectionChange)
    }

    private fun interceptSelectionChange(chain: XposedInterface.Chain): Any? {
